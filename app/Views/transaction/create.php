                        ...
                        <form action="/transaction/store" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" inputmode="numeric" name="amount" class="form-control" id="amount" value="<?= set_value('amount') ?>" placeholder="Example: 50000" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                                </div>
                            </div>
